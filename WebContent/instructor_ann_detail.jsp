...
<!-- menu !-->
		<div class = "row col-md-10 col-md-offset-1 page">
			...
			<div class="col-md-9 contents">
				...
				<div class = "row write">
					<a class="btn btn-primary" href="instructor_ann_write.jsp" role="button">New Announcement</a>
					<a class="btn btn-primary" href="instructor_ann_write.jsp" role="button">Edit</a>
					<a class="btn btn-danger" href="instructor_annlist.jsp" role="button">Delete</a>
				</div>
				
<!--form!-->
<!--Should get Announcement Title and Detail, instructor name (and maybe date)-->
				Detail of Ann
        	</div>
   	  </div>
</div>
