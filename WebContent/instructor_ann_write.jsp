		...
		<div class = "row col-md-10 col-md-offset-1 page">
			...
			<div class="col-md-9 contents">
				...
				<div class = "row unp">
					...
					<a class="btn btn-primary" href="instructor_annlist.jsp" role="button">Save</a>
					<a class="btn btn-primary" href="instructor_ann_unp.jsp" role="button">Get saved announcement</a>
					<a class="btn btn-default" href="instructor_annlist.jsp" role="button">Cancel</a>
				</div>
				
<!--form!-->			
<!--Write announcement with blank TItle and Contents-->
				Write Ann
        	</div>
   	  </div>
</div>
