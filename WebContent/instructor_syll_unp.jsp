		...
		<div class = "row col-md-10 col-md-offset-1 page">
			<div class="col-md-2 menu">
				<ul class="nav nav-default nav-pills nav-stacked">
					<li><a href="instructorcoursemain.jsp"><i class="menucoursemain"></i>Course Main</a></li>
					<li><a href="instructorlistofann.jsp"><i class="menuannouncement"></i>Announcement</a></li>
					<li class="active"><a href="instructorsyll.jsp"><i class="menusyllabus"></i>Syllabus</a></li>
					<li><a href="instructorlistofstudent.jsp"><i class="menustudent"></i>Students</a></li>
	            </ul>
			</div>			
			...
			<div class="col-md-9 contents">
				...
				<div class = "row unp">
					...
					<a class="btn btn-danger" href="instructor_syll_write.jsp" role="button">Delete</a>
					<a class="btn btn-default" href="instructor_syll.jsp" role="button">Cancel</a>
				</div>
				
<!--form!-->
<!--		list of unpub syllabus with dotted checkbox             -->
				list of unpub syll with dotted checkbox
        	</div>
   	  </div>
</div>
