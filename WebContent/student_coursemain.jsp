		...
		<div class = "row col-md-10 col-md-offset-1 page">
			<div class="col-md-2 menu">
				<ul class="nav nav-default nav-pills nav-stacked">
					<li class="active"><a href="student_coursemain.jsp"><i class="menucoursemain"></i>Course Main</a></li>
					<li><a href="student_annlist.jsp"><i class="menuannouncement"></i>Announcement</a></li>
					<li><a href="student_syll.jsp"><i class="menusyllabus"></i>Syllabus</a></li>
	            </ul>
			</div>			
<!--form!-->
<!--Should get Course discription in contents box-->
