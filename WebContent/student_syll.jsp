...
<body>
	<div class="container-fluid" onload="./DisplaySyllbServlet">	
<!--head(?)!-->
		...
		<div class = "row col-md-10 col-md-offset-1 page">
			<div class="col-md-2 menu">
				<ul class="nav nav-default nav-pills nav-stacked">
					<li><a href="student_coursemain.jsp"><i class="menucoursemain"></i>Course Main</a></li>
					<li><a href="student_annlist.jsp"><i class="menuannouncement"></i>Announcement</a></li>
					<li class="active"><a href="student_syll.jsp"><i class="menusyllabus"></i>Syllabus</a></li>
				</ul>
			</div>			
...
<!--Detail of Syllabus -->
			...
			<%String path = "./DisplaySyllbServlet?courseID=" + request.getParameter("courseID");%>
			<%-- <jsp:include page="/DisplaySyllbServlet?courseID=" + ${requestScope.courseID}/> --%>
			<%-- <jsp:include page=<%=path %>/> --%>
			<jsp:forward page="./TestServlet?a=1"></jsp:forward>
			<div><%=request.getAttribute("content") %></div>
			<%-- <jsp:include page="./DisplaySyllbServlet?courseID=1" /> --%>
